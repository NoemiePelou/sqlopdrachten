...
SELECT naam, roepnaam, cursistnr, geslacht FROM cursist WHERE geslacht = 'V'
...
SELECT naam, roepnaam, cursistnr, geslacht FROM cursist WHERE geslacht != 'M'

### Opdracht 5
* Geef de query voor een overzicht van alle cursisten die in Breda wonen en vrouw zijn.
SELECT naam, roepnaam, cursistnr, geslacht, plaats FROM cursist WHERE geslacht = 'V' and plaats = 'Breda'

### Opdracht 6
* Geef de query voor een overzicht van alle cursisten die in Oosterhout of Made wonen.
SELECT naam, roepnaam FROM cursist WHERE plaats = 'Oosterhout' OR plaats = 'Made'
